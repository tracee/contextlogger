...
public class ExternalWrapperIntegrationTest {
    ...
    public void should_wrap_with_external_wrappers_correctly_using_enhanced_profile() {
        ...
        MatcherAssert.assertThat(result, Matchers.is("{\"" + TypeProviderFunction.OUTPUT_STRING_TYPE + "\":\"testdata\",\"testoutput\":\"String<'IT WORKS !!!'>\"}"));
    ...
    public void should_wrap_with_implicit_context_provider_correctly_using_enhanced_profile() {
        ...
        MatcherAssert.assertThat(result, Matchers.is("{\"" + TypeProviderFunction.OUTPUT_STRING_TYPE + "\":\"testImplicitContextData\",\"output\":\"String<'IT WORKS TOO!!!'>\"}"));
