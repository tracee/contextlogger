...
The example consists of two log statements of two related applications generated by the context logger  (Servlet and JAX-Ws). The Log statements were aggregated by using the TracEE Framework.

Both statements will help you to analyze the error.
