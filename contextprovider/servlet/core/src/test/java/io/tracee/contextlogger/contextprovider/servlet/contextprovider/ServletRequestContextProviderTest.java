...
public class ServletRequestContextProviderTest {
    ...
    public void should_return_request_parameters() {
        ...
        final List<NameValuePair<String>> result = unit.getHttpParameters();
    ...
    public void should_return_http_headers() {
        ...
        final List<NameValuePair<String>> result = unit.getHttpRequestHeaders();
    ...
    public void should_return_request_attributes() {
        ...
        final List<NameValuePair<Object>> result = unit.getHttpRequestAttributes();
