package io.tracee.contextlogger.provider.api;

/**
 * Annotation to mark methods annotated by {@link io.tracee.contextlogger.provider.api.TraceeContextProviderMethod}
